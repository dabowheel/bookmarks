        ...
        <div class="modal-body">
          <form class="form-inline">
            <div class="form-group">
              <input v-model="name" id="name" class="form-control" type="text" placeholder="Name" />
              <input v-model="url" id="url" class="form-control" type="text" placeholder="URL" />
              <button class="btn btn-default" type="button">Validate</button>
            </div>
          </form>
        </div>
        <div class="modal-footer">
          <button v-on:click="clickAcceptAdd" id="acceptAdd" disabled type="button" class="btn btn-primary">Accept</button>
